    ...
    return(
        ...
        <div className="homepage_second_div">
          <div className="second_div_textplace">
            ...
            <p>
              we provide with our customers with the best experience, as well
              as having wide range of products and items, we are proud to say
              that we have competing prices and discounts, and we provide
              customers with high level of security when it comes to delivery
              and information,
            </p>
          </div>
